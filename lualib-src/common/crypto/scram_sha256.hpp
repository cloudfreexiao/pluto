    ...
    namespace scram {
        ...
        public:
            ...
            void process_server_first(const std::string& server_first_message) {
                ...
                salt_ = pluto::base64_decode(salt_b64);
            ...
            std::string prepare_final_message() {
                ...
                std::string channel_binding_data = pluto::base64_encode("n,,"); // "n,," -> "bixz"
                ...
                std::string proof =
                    pluto::base64_encode(client_proof_vec.data(), client_proof_vec.size());
            ...
            void process_server_final(const std::string& server_final_message) {
                ...
                auto server_signature = pluto::base64_decode(server_signature_b64);
